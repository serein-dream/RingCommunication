...
def get_args():
    ...
    parser.add_argument('--lr', type=float, default=0.05, help='Training learning rate.')
    parser.add_argument('--lr_gamma', type=float, default=0.1, help='Training learning rate gamma.')
